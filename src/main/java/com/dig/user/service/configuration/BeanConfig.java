...
import com.dig.user.service.configuration.interceptor.RestTemplateInterceptor;
...
public class BeanConfig {
	...
	//declaring the oAuth2AuthorizesClient bean for manager object of feignclientinterceptor class
